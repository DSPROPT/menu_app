export const drinks =  [
      ...
      { id: "gin_tonic", name: "Gin Tonic", price: "7€", description: "Refrescante cóctel con ginebra y tónica.", ingredients: ["Ginebra", "Tónica", "Lima"], imageKey: "gin_tonic" },
      { id: "caipirinha_maracuja", name: "Caipirinha Maracuyá", price: "5.50€", description: "Caipirinha con sabor a maracuyá.", ingredients: ["Cachaça", "Azúcar", "Lima", "Maracuyá"], imageKey: "caipirinha_maracuja" },
